...
<title>ZGTv Peliculas - Series - Animes</title>

<script>
$(document).ready(function(){
    $("boton1").click(function(){
        $("#div1").load("carpetas.php");
    });
});
$(document).ready(function(){
    $("boton2").click(function(){
        $("#div1").load("estrenos.php");
    });
});
$(document).ready(function(){
    $("boton3").click(function(){
        $("#div1").load("series.php");
    });
});
</script>
...
<a href="#" class="ui-btn ui-icon-grid ui-btn-icon-left"><boton1>Todos los Animes</boton1></a>
<a href="#" class="ui-btn ui-icon-star ui-btn-icon-left"><boton2>Animes en Estreno</boton2></a>
<a href="#" class="ui-btn ui-icon-video ui-btn-icon-left"><boton3>Series</boton3></a>

<ul>
     <li class="active"><boton1>Todos los Animes</boton1></li>
     <li class="active"><boton2>Animes en Estreno</boton2></li>
     <li class="active"><boton3>Series</boton3></li>
    </ul>
...
<div id="div1" role="main" class="ui-content" align="center">
    
    <div id="div1">
    <?php echo include 'carpetas.php'; ?>
    </div>
